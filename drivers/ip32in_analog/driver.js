...
class IP32INAnalogDriver extends Homey.Driver {

  /**
   * Shared with the digital and temperature drivers: all three read the same
  ...
  async onPair(session) {
    ...
    session.setHandler('list_devices', async () => {
      ...
      return channels.map((ch) => ({
        ...
        data: {
          id: `${boardSettings.address}-analog-${ch.index}`,
        },
        store: {
...
module.exports = IP32INAnalogDriver;
