...
class IP32INTemperatureDriver extends Homey.Driver {

  /**
   * Shared with the digital and analog drivers: all three read the same
  ...
  async onPair(session) {
    ...
    session.setHandler('list_devices', async () => {
      ...
      return channels.map((ch) => ({
        ...
        data: {
          id: `${boardSettings.address}-temperature-${ch.index}`,
        },
        store: {
...
module.exports = IP32INTemperatureDriver;
